...
NOTEBOOK_TEMPLATES_DIR = os.path.normpath(os.path.join(HERMIONE_DIR, 'data', 'notebook_templates'))
...
@notebook.command()
@click.argument('template_file', type=click.Path(exists=True, dir_okay=False, readable=True))
