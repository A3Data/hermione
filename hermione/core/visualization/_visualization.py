...
class Visualizer:
  ...
  def regression_analysis( y_true, y_pred, path=None):
    ...
    print("Histogram")
    Visualizer.histogram(residual, "Residual")
    print("Scatter")
    Visualizer.scatter(y_pred, residual, "pred", "residual", path=path)
    print("Scatter")
    Visualizer.scatter(y_true, y_pred, "y_test", "pred", path=path)
  ...
  @staticmethod
  def scatter(x, y, xlabel, ylabel, fig_size=(5,4), groups=None,
              group_color=None, path=None, title=''):
    """
    Plot scatter
  ...
  @staticmethod
  def bar(x, y, xlabel, ylabel, fig_size=(5,4), est=np.mean, groups=None,
          group_color=None, path=None):
    """
    Plot bar
  ...
  @staticmethod
  def line(x, y, xlabel, ylabel, fig_size=(5,4), est=np.mean, groups=None,
           group_color=None, path=None):
    """
    Plot bar
  ...
  @staticmethod
  def scatter_interactive(df, col_name_x,  col_name_y, xlabel, ylabel, hover,
                          fig_size=(400,300), **kwargs):
    """
    Interactive plotter
  ...
  @staticmethod
  def bar_interactive(df, col_name_x, col_name_y, xlabel, ylabel, hover,
                      fig_size=(400,300), **kwargs):
    """
    Interactive plotter
  ...
  @staticmethod
  def line_interactive(df, col_name_x, col_name_y, xlabel, ylabel, hover,
                       fig_size=(400,300), **kwargs):
    """
    Interactive plotter
  ...
  @staticmethod
  def density_plot(list1, list2, title='', label1='', label2='',
                   fig_size=(5,4), path=None):
    """
    Plot density
