...
class Visualizer:
    ...
    def missing_analysis(df):
        ...
        df_isnull = df_isnull.drop(df_isnull[df_isnull == 0].index).sort_values(
            ascending=False
        )
    ...
    def scatter_interactive(
        df, col_name_x, col_name_y, xlabel, ylabel, hover, fig_size=(400, 300), **kwargs
    ):
        """
        Interactive plotter
    ...
    @staticmethod
    def density_plot(
        list1, list2, title="", label1="", label2="", fig_size=(5, 4), path=None
    ):
        """
        Plot density
