import os
import json
from .templates import build_barebones_template,\
...
TEMPLATES = [
    {
        "name": "starter",
        "factory": build_starter_template
    },
    {
        "name": "barebones",
        "factory": build_barebones_template
    },
    {
        "name": "sagemaker",
        "factory": build_sagemaker_template
    }
]
...
def create_project(project_path, project_name, template_name, context_data, output_blueprint=False):
    ...
    if output_blueprint:
        ...
        with open(os.path.join(project_path, project_name, f"{project_name}_blueprint.json"), 'w', encoding='utf-8') as f:
